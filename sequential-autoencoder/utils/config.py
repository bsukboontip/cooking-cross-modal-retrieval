...
def get_args():
    ...
    parser.add_argument('--evaluate_freq', default=1, type=int)
    parser.add_argument('--save_freq', default=1, type=int)
    parser.add_argument('--wandb_log_every', default=20, type=int)
    ...
    parser.add_argument('--retrieval_mode', default='im2recipe', type=str, choices=['im2recipe', 'recipe2im'])
